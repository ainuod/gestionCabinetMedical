    ...
    public static void main(String[] args) {
        ...
        while (true) {
            if (language.equals("FR")) {
                ...
                System.out.println("4. Ajouter une consultation (Terminer un rendez-vous)");
                ...
                System.out.println("4. Add Consultation (Complete Appointment)");
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 6 -> {
                        if (language.equals("FR")) {
                            System.out.println("Système quitté. Au revoir !");
                        } else {
